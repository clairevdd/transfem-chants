...
TAGS = {
    ...
    '6BGmeieR3l4aW0VT2nvOcX': {'discogs': ['folk, world, & country'], 'musicbrainz': [], 'lastfm': []},  # Alicia Ramos — Con Sangre (Discogs genre of the album Lumpenprekariät, 2008; Last.fm track.gettoptags and artist.gettoptags both empty; MusicBrainz found no recording)
    '4qdyN6rpaGsspGeMzkCTNP': {'discogs': ['dance-pop', 'electro', 'hyperpop'], 'musicbrainz': [], 'lastfm': []},  # Amethyst, Ayesha Erotica — C U L8R (Discogs styles of the mixtape Amy, 2024; Last.fm artist tags returned are for a same-named Swiss heavy-metal band, a homonym, and are not used; MusicBrainz found no recording)
    '6S04kJTdogPGPWN3jP7mNt': {'discogs': [], 'musicbrainz': [], 'lastfm': []},  # Anthony Lexa — Avoid The Sun (recent 2026 single, no Discogs or MusicBrainz entry yet; Last.fm under the stage name "LEXA" returns a same-named Brazilian pop singer, a homonym, and is not used)
    '6BlQbt6Cnf54niyISOZ6cB': {'discogs': ['latin'], 'musicbrainz': [], 'lastfm': []},  # Assucena — Menino Pele Cor de Jambo (Discogs genre "Latin" / style "MPB" of the album Lusco-Fusco; Last.fm artist tags "brazil"/"brasil"/"brazilian" filtered by GEO_BLOCK, "female vocalists"/"nacional"/"samba" excluded as noise or below the count>=10 threshold; MusicBrainz recording has no genres)
    '2R7G2Itn0b73uthZCNPIrR': {'discogs': [], 'musicbrainz': [], 'lastfm': ['funk', 'pop', 'rap']},  # Bixarte — Maria Padilha (no Discogs entry found; Last.fm artist tag "trans" (100) filtered by IDENTITY_BLOCK, "paraiba" (15, a Brazilian state name) excluded as geographic noise, "brazilian" below threshold; MusicBrainz recording has no genres)
    '2YDCrMvvmBz9gVeuL8QyVG': {'discogs': ['reggae'], 'musicbrainz': [], 'lastfm': []},  # Brigitte Bond — Blue Beat Baby (Discogs genre "Reggae" / style "Ska" of the 1964 7" single on Blue Beat; no usable Last.fm tags found; MusicBrainz recording has no genres)
    '4v5gEVQPDlPtsuQ77AJa0x': {'discogs': [], 'musicbrainz': [], 'lastfm': ['pop', 'fashion', 'electropop']},  # Britney Manson — FASHION (no Discogs entry found; Last.fm artist tags "estonian"/"russian" filtered as geographic/demonym noise, "tiktok" and others below the count>=10 threshold; MusicBrainz recording has no genres)
}
